...
namespace Aurora
{
	class UTILLIB_API Exception : public std::exception
    {
    protected:
        long line;
        int number;
	...
	class UTILLIB_API UnimplementedException : public Exception 
	{
	public:
	...
	class UTILLIB_API FileNotFoundException : public Exception
	{
	public:
	...
	class UTILLIB_API IOException : public Exception
	{
	public:
	...
	class UTILLIB_API InvalidStateException : public Exception
	{
	public:
	...
	class UTILLIB_API InvalidParametersException : public Exception
	{
	public:
	...
	class UTILLIB_API ItemIdentityException : public Exception
	{
	public:
	...
	class UTILLIB_API InternalErrorException : public Exception
	{
	public:
	...
	class UTILLIB_API RenderingAPIException : public Exception
	{
	public:
	...
	class UTILLIB_API RuntimeAssertionException : public Exception
	{
	public:
