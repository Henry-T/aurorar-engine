...
namespace Aurora
{
    ...
    public:
        ...
        MATHLIB_API friend Vector3 operator* (const Vector3& rkVector,
            const Matrix3& rkMatrix);

        Matrix3 operator* (Real fScalar) const;

        MATHLIB_API friend Matrix3 operator* (Real fScalar, const Matrix3& rkMatrix);
